...
function validate(req, res) {
  const data = req.params.email.split("~");
    // TODO: the tillde isnt right we should pass params
  const email = data[0];
  const securityCode = data[1];
  // TODO: Save security code and email to database
        ...
        <td style="text-align:center">
          ...
          <tr>
            <td>
              ...
              <a href="https://www.dac.city/dashboard/profile/${securityCode}/"><button type="button" style="cursor: pointer; outline: none; font-weight: 600; border-radius:3px; background-color: #37527A; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 15px; width:250px">Verify Email</button></a></br></br>
              ...
              <a href="https://www.dac.city/dashboard/profile/${securityCode}/">https://www.dac.city/dashboard/profile/${securityCode}/</a></br></br></br>
