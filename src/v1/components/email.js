                ...
                <td style="text-align:center">
                  ...
                  <tr>
                    <td>
                      ...
                      <a href="https://portal-b.worbli.io/dashboard/profile/${newjwt}/"><button type="button" style="cursor: pointer; outline: none; font-weight: 600; border-radius:3px; background-color: #37527A; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 15px; width:250px">Verify Email</button></a></br></br>
                      ...
                      <a href="https://portal-b.worbli.io/dashboard/profile/${newjwt}/">https://portal-b.worbli.io/dashboard/profile/${newjwt}/</a></br></br></br>
